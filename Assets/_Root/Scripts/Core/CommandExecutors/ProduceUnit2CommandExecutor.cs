...
{
    public class ProduceUnit2CommandExecutor : CommandExecutorBase<IProduceUnit2Command>, IUnitProducer
    {
        ...
        public override async Task ExecuteSpecificCommand(IProduceUnit2Command command)
        {
